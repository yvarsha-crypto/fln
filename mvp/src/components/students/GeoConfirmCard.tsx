...
/**
 * Read-only confirmation card showing school / class / section.
 * Follows Version_1.0.md §3.2: school is server-derived (never user-entered).
 * The "School Code" appears here as a hidden (not editable) display field.
 */
