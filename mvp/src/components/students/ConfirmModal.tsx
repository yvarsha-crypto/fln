...
/**
 * Generic confirmation modal with type-to-confirm safety.
 *
 * To confirm a destructive action the user must type `confirmWord` exactly
 * (case-sensitive). The Confirm button stays disabled until the input matches.
 *
 * Match the existing Teacher Dashboard modal pattern:
 * `bg-white rounded-2xl border-zinc-200 shadow-2xl` on a `bg-black/50 backdrop-blur-sm` overlay.
 */
