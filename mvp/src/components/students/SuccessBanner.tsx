...
/**
 * Success banner shown after a student is successfully registered.
 *
 * Renders the MongoDB ObjectId studentId and the key fields as confirmation.
 * Per Version_1.0.md §3.2 the studentId is the public id displayed to the
 * Teacher (a 24-character hex string).
 */
